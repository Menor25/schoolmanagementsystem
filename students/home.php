	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
				...
				<footer>
					<p>&copy 2019 <a href="#" target="_blank">MenorMediaConcepts</a> . All Rights Reserved | Design by Menor.</a> and Develop MenorMediaConcept</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Menor</h1></span> 
